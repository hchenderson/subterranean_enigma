        ...
        {isLoaded && (
          hasKey ? (
            <div className="text-center space-y-6 p-8 bg-card/50 rounded-lg animate-fade-in">
              ...
              <h2 className="text-3xl font-bold text-accent">Network Secured</h2>
              <p className="text-muted-foreground">You have extracted the {roomData.keyName} fragment from the Network's core. The data streams now flow without corruption.</p>
              <AureliaMessage text="Data integrity verified. Misinformation packets purged. The final key fragment is yours. All sub-protocols point towards the Nexus." />
              <Link href="/" passHref>
            ...
            <div className="space-y-6">
              <AureliaMessage text="Warning: Signal degradation detected. The Shrouded Network is a labyrinth of ciphers and deliberate misinformation. Trust nothing. Verify everything." />
              <PuzzlePlaceholder
